...
use App\Http\Livewire\Admin\AdminEditdProductComponent;
...
Route::middleware(['auth:sanctum', 'verified','authadmin'])->group(function () {
    ...
    Route::get('/admin/product/edit/{product_slug}',AdminEditdProductComponent::class)->name('admin.editproduct');
