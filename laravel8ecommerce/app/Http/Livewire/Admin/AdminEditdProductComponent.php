...
class AdminEditdProductComponent extends Component
{
    use WithFileUploads;
    public $name;
    public $slug;
    ...
    public function mount($product_slug) {
        ...
        // dd($product->attributeValues->where('product_id',$product->id)->unique('product_attribute_id')->pluck('product_attribute_id'));
    ...
    public function render()
    {
        ...
        return view('livewire.admin.admin-editd-product-component',[
