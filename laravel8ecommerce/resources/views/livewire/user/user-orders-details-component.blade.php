                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($order->status == 'ordered')
                                    <a href="#" wire:click.prevent="cancelOrder({{ $order->id }})"
                                        style="margin-right:10px" class="btn btn-warning pull-right">Cancel Order</a>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach ($order->OrderItems as $item)
                                    <li class="pr-cart-item">
                                        ...
                                        @if ($order->status == 'delivered' && $item->rstatus == false)
                                            <div class="price-field sub-total">
                                                <p class="price"><a
                                                        href="{{ route('user.review', $item->id) }}">Write Review</a>
                                                </p>
                                            </div>
                                        @endif
                                    </li>
