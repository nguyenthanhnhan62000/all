                            ...
                            @foreach (Cart::instance('cart')->content() as $item)
                                <li class="pr-cart-item">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <p wire:click.prevent="switchToSaveForLater('{{ $item->rowId }}')"
                                            class="text-center"><a href="#">Save For Later</a></p>
                                    </div>
                    ...
                    <div class="order-summary">
                        ...
                        @if (Session::has('coupon'))
                            <p class="summary-info"><span class="title">Discount
                                    ({{ Session::get('coupon')['code'] }}) <a wire:click.prevent="removeCoupon"
                                        href="#"><i class="fa fa-times text-danger"></i></a> </span><b
                                    class="index">-${{ number_format($discount, 2) }}</b></p>
                            <p class="summary-info"><span class="title">Subtitle With Discount</span><b
                    ...
                    <div class="checkout-info">
                        @if (!Session::has('coupon'))
                            <label class="checkbox-field">
                                <input wire:model="haveCouponCode" value="1" class="frm-input" name="have-code"
                                    id="have-code" type="checkbox"><span>I have coupon code</span>
                            </label>
                            @if ($haveCouponCode == 1)
                                <div class="summary-item">
                                    <form wire:submit.prevent="applyCouponCode">
                                        ...
                                        <p class="row-in-form">
                                            ...
                                            <input wire:model="couponCode" type="text" name="coupon-code">
                                        </p>
                    ...
                    <ul class="products-cart">
                        ...
                        @foreach (Cart::instance('saveForLater')->content() as $item)
                            <li class="pr-cart-item">
                                ...
                                <div class="quantity">
                                    <p wire:click.prevent="moveToCart('{{ $item->rowId }}')" class="text-center">
                                        <a href="#">Move To Cart</a></p>
                                </div>
                                <div class="delete">
