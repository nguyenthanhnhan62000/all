...
<body class="home-page home-01 ">
										...
										@if(Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item" >
														<a title="Manger Home Slider" href="{{ route('admin.homeslider') }}">Manger Home Slider</a>
													</li>
													<li class="menu-item" >
														<a title="Manger Home Categories" href="{{ route('admin.homecategories') }}">Manger Home Categories</a>
													</li>
													<li class="menu-item" >
													...
													<li class="menu-item" >
														<a title="Contact" href="{{ route('admin.contact') }}">Contact Messages</a>
													</li>
													<li class="menu-item" >
														<a title="Settings" href="{{ route('admin.settings') }}">Settings</a>
													</li>
													<li>
														<a type="button" id="btnLogoutAdmin">logout</a>
													</li>
												</ul>
											</li>
										@else
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li>
														<a type="button" id="btnLogoutUser">logout</a>
													</li>
												</ul>
											</li>
										@endif
	...
	<form id="form-submit-logout" action="{{ route('logout') }}" method="post">
		@csrf								
	</form>
	...
	<script>
		var btnLogoutAdmin = $('#btnLogoutAdmin')
		var btnLogoutUser = $('#btnLogoutUser')
		var formSubmitLogout = $('#form-submit-logout')
