    ...
    <header id="header" class="header-v3">
        <nav class="flat-mega-menu">
            ...
            <ul class="collapse">
                ...
                <li> <a href="/service-categories">Service Categories</a>
                ...
                @if (Route::has('login'))
                    @auth
                        @if (auth()->user()->utype === 'ADM')
                            <li class="login-form"> <a href="#" title="">My Account(Admin)</a>
                                <ul class="drop-down one-column hover-fade">
                        ...
                        @elseif(auth()->user()->utype === 'SVP'))
                            <li class="login-form"> <a href="#" title="">My Account(SVP)</a>
                                <ul class="drop-down one-column hover-fade">
                        ...
                        @else
                        <li class="login-form"> <a href="#" title="">My Account(Customer)</a>
                            <ul class="drop-down one-column hover-fade">
                    ...
                    @else
                        <li class="login-form"> <a href="/register" title="Register">Register</a></li>
                        <li class="login-form"> <a href="login" title="Login">Login</a></li>
                    @endauth
                @endif
                <li class="search-bar">
                </li>
