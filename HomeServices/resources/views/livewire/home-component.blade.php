            ...
            <div class="tp-banner">
                <ul>
                    ...
                    <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000"
                        ...
                        <img src="{{ asset('images/slider/'. $slider->image) }}" alt="{{ $slider->title }}" data-bgposition="center center"
        ...
        <section class="content-central">
                        ...
                        <div class="col-md-12">
                            <ul id="sponsors" class="tooltip-hover">
                                ...
                                <li data-toggle="tooltip" title="" data-original-title="{{ $scategory->name }}"> <a
                                        href="{{ route('home.service_by_category',$scategory->slug) }}"><img src="{{ asset('images/categories/'. $scategory->image) }}"
                    ...
                    <div class="container">
                        ...
                        <div class="portfolioContainer" style="margin-top: -50px;">
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="{{ route('home.service_details',$service->slug) }}">
                                    <div class="img-hover">
                                    ...
                                    <div class="info-gallery">
                                        ...
                                        <hr class="separator">
                                        <p>{{ $service->name }}</p>
                                        <div class="content-btn"><a href="{{ route('home.service_details',$service->slug) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <ul class="services-lines">
                                    ...
                                    <li>
                                        <a href="{{ route('home.service_by_category',$fcategory->slug) }}">
            ...
            <div>
                ...
                <div id="boxes-carousel">
                    ...
                    <div>
                        <a class="g-list" href="{{ route('home.service_details',$aservice->slug) }}">
                            <div class="img-hover">
                            ...
                            <div class="info-gallery">
                                ...
                                <div class="content-btn"><a href="{{ route('home.service_details',$aservice->slug) }}"
                                        class="btn btn-primary">Book Now</a></div>
