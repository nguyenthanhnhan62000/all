                                ...
                                <div class="panel panel-default">
                                      ...
                                      <div class="panel-body">
                                          @if (session()->has('message'))<div class="alert alert-success">  {{ session('message') }}</div> @endif
                                            <form class="form-horizontal" method="get" wire:submit.prevent="updateService">
                                                @csrf
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input wire:model="newthumbnail" type="file" class="form-control-file">
                                                            @if($newthumbnail)
                                                                <img src="{{ $newthumbnail->temporaryUrl() }}" width="60">
                                                            @else
                                                                <img src="{{ asset('images/services/thumbnails/'.$thumbnail) }}" width="60">
                                                            @endif
                                                            @error('newthumbnail') <span class="error">{{ $message }}</span> @enderror
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
