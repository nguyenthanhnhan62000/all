                    ...
                    <div class="detail-info">
                        <div class="product-rating">
                            ...
                            <?php
                                ...
                                if ($product->orderItems) {
                                    $countRating = $product->orderItems->where('rstatus',1)->count();
                                }
                            ?>
                            ...
                            @else
                                ...
                                <i class="fa fa-star " aria-hidden="true"></i>	
                            @endif	
                            <a href="#" class="count-review">({{ $countRating }} review)</a>
                        </div>
                        ...
                        <div class="quantity">
                            ...
                            <div class="quantity-input">
                                ...
                                <a wire:click.prevent="decreseQuantity" class="btn btn-reduce" href="#"></a>
                                <a wire:click.prevent="incrementQuantity" class="btn btn-increase" href="#"></a>
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="review">
                                ...
                                <div class="wrap-review-form">
                                    ...
                                    <div id="comments">
                                        <h2 class="woocommerce-Reviews-title">{{ $countRating }} <span>{{ $product->name }}</span></h2>
                                                ...
                                                <div id="comment-20" class="comment_container"> 
                                                    ...
                                                    <div class="comment-text">
                                                        ...
                                                        <p class="meta"> 
                                                            ...
                                                            <time class="woocommerce-review__published-date" datetime="2008-02-14 20:00">{{ Carbon\Carbon::parse($orderItem->review->created_at)->format('d F Y g:i A') }}</time> </time>
                                                        </p>
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('product.details',$p_product->slug) }}" class="product-name"><span>{{ $p_product->name }}</span></a>
