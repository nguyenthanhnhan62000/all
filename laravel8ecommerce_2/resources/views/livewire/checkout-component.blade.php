                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form fill-wife">
                                    ...
                                    <label class="checkbox-field">
                                        <input wire:model="ship_to_different" name="different-add" id="different-add"
                        ...
                        <div class="col-md-12">
                            <div class="wrap-address-billing">
                                ...
                                <div class="billing-address">
                                    ...
                                    <p class="row-in-form">
                                        <label for="phone">Phone number<span>*</span></label>
                                        <input type="number" value="" placeholder="10 digits format"
                                            wire:model="s_mobile">
                                    ...
                                    <p class="row-in-form">
                                        <label for="zip-code">Postcode / ZIP:</label>
                                        <input type="number" value="" placeholder="Your postal code"
                        ...
                        @if ($paymentmode == 'card')
                            <div class="wrap-address-billing">
                                ...
                                <p class="row-in-form">
                                    ...
                                    @error('exp_month') <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="exp-year">Expiry Month</label>
                                    <input type="text" value="" placeholder="YYYY" wire:model="exp_year">
                                    @error('exp_year') <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                                <p class="row-in-form">
